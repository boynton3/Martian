...
### 1. Add landing success/failure logic
### 2. Detect crash (velocity too high or fuel out)

## PHASE 4: Game Loop / Simulation Logic
### 1. Organize code into files (main.cpp, Lander.h, Lander.cpp)
### 2. Add CLI flags or basic menu
### 3. Write README.md + usage guide
